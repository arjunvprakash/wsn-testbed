...
void STEM_init(MAC*, unsigned char);

int STEM_recv(MAC*, unsigned char*);
int STEM_tryrecv(MAC*, unsigned char*);
int STEM_timedrecv(MAC*, unsigned char*, unsigned int);

int STEM_send(MAC*, unsigned char, unsigned char*, unsigned int);
int STEM_Isend(MAC*, unsigned char, unsigned char*, unsigned int);
